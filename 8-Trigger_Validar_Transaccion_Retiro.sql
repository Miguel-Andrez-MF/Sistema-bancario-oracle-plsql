...
BEGIN
    ...
    FROM PROYECTODB.TBL_TIPOS_PARAMETROS
    WHERE UPPER(NOMBRE) = 'RETIRO';
    
    DBMS_OUTPUT.PUT_LINE('Intentando retiro de $100,000 en cuenta CTA-1...');
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        DBMS_OUTPUT.PUT_LINE('');
        DBMS_OUTPUT.PUT_LINE('Línea: ' || DBMS_UTILITY.FORMAT_ERROR_BACKTRACE);
END;
/
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Intentando retiro de $999,999,999 en cuenta CTA-1...');
...
BEGIN
    ...
    FROM PROYECTODB.TBL_TIPOS_PARAMETROS
    WHERE UPPER(NOMBRE) = 'DEPOSITO';
    
    DBMS_OUTPUT.PUT_LINE('Realizando depósito de $500,000 en cuenta CTA-1...');
